...
class TrainDepartureRegisterTest {
    ...
    void addTrainDeparture() {
        ...
        TrainDeparture trainDepartureNumber1 = new TrainDeparture(1, "test", 1, "test", 1, 1, 1);
        tdr.addTrainDeparture(trainDepartureNumber1);
        TrainDeparture trainDepartureNumber2 = new TrainDeparture(2, "test", 2, "test", 2, 2, 2);
